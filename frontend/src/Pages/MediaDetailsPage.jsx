...
const ReviewCard = ({ review }) => {
  ...
  const userName = review.usuario_nome || review.nome || 'Anônimo';
  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow-lg">
      <div className="flex items-center mb-2">
        <img
          src={review.foto_perfil || getAvatarUrl(userName)}
          alt={userName}
...
const MediaDetailsPage = () => {
  ...
  const releaseYear = movie.release_date
    ...
    : 'N/A';
  const ourRating = movie.vote_average
        ...
        >
          ...
          <div className="absolute top-4 right-4 flex flex-col gap-3">
            ...
            <button
              ...
              className={`text-white hover:opacity-80 backdrop-blur-sm transition-all duration-200 transform font-semibold cursor-pointer z-10 px-4 py-2 rounded-full flex items-center gap-2
                ${
                  isInFavorites
